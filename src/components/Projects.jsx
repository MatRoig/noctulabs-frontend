    ...
    return (
        <section id="proyectos" className="relative z-10 px-6 py-20 max-w-7xl mx-auto border-t border-noct-border text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 text-left">
                {/* Proyecto Activo */}
                <a href="https://www.myfavoriterug.com/" target="_blank" rel="noopener noreferrer" className="group bg-[#0a0818] border border-noct-border hover:border-noct-purple rounded-xl overflow-hidden transition-all block">
                ...
                <div className="group bg-[#0a0818] border border-noct-border hover:border-orange-500 rounded-xl overflow-hidden transition-all">
                    <div className="bg-orange-900/20 h-48 flex items-center justify-center border-b border-noct-border p-6">
                        <h4 className="font-display text-3xl font-bold text-orange-200 uppercase text-center leading-none transition-transform group-hover:scale-105">Próximamente</h4>
                    </div>
                    <div className="p-5 flex justify-between items-center bg-[#0a0818]">
                        <div>
                            <h4 className="font-bold text-sm uppercase">Próximamente</h4>
                ...
                <div className="group bg-[#0a0818] border border-noct-border hover:border-blue-500 rounded-xl overflow-hidden transition-all">
                    <div className="bg-blue-900/20 h-48 flex items-center justify-center border-b border-noct-border p-6">
                        <h4 className="font-display text-3xl font-bold text-blue-200 uppercase text-center leading-none transition-transform group-hover:scale-105">Próximamente</h4>
                    </div>
                    <div className="p-5 flex justify-between items-center bg-[#0a0818]">
                        <div>
                            <h4 className="font-bold text-sm uppercase">Próximamente</h4>
            ...
            <button className="border border-noct-border hover:border-noct-neon px-8 py-3 rounded text-sm font-bold uppercase transition-all">
                {t.projects.btn}
            </button>
        </section>
    );
